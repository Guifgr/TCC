...
public static class ContextHttpExtensions
{
    public static string GetHttpContextId(this HttpContext context)
    {
        ...
        if (id == null) throw new BadRequestException("Token não autorizado para a requisição");
        return id["id: ".Length..];
    }
    ...
    public static string GetHttpContextCdClient(this HttpContext context)
    {
        ...
        if (cdClient == null) throw new BadRequestException("Token não autorizado para a requisição");
